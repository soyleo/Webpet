...
class WebPet {
  constructor(nombre, img, vida, tipo, tipoValue) {
    this.nombre = nombre;
    this.img = img;
    this.vida = vida;
...
let wispy = new WebPet("Wispy", "../Img/wispy.png", 200, "Fuego", "fuego");
let bubbles = new WebPet("Bubbles", "../Img/bubbles.png", 200, "Agua", "agua");
let lizzy = new WebPet("Lizzy", "../Img/lizzy.png", 200, "Planta", "planta");
let dusty = new WebPet("Dusty", "../Img/dusty.png", 200, "Tierra", "tierra");
let frostiling = new WebPet("Frostiling", "../Img/frostiling.png", 200, "Hielo", "hielo");
let purrly = new WebPet("Purrly", "../Img/purrly.png", 200, "Normal", "normal");
